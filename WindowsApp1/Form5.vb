...
Public Class Form5
    ...
    Private Sub Inject()
        ...
        My.Computer.FileSystem.WriteAllText("c:\temp\Loader\Artificial Aim.Hook.DLLname", filename, False)
        Timer1.Stop()
    ...
    Private Sub Form5_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If (Form3.ListBox1.SelectedItem = "Radical Heights") Then
            exe = "RadicalHeights"
            dll = "http://artificialaim.net/ayyware.dll" ' Main build
        ElseIf (Form3.ListBox1.SelectedItem = "Custom Injector") Then
            Form4.Show()
            Me.Close()
        End If
